package com.tranner.account_service.exception.custom;

import com.tranner.account_service.exception.AccountErrorCode;

public class InterenalServerException extends RuntimeException {

  private final AccountErrorCode code; // 예외 코드
  private final String detailMessage;

  // 생성자: 예외 코드만 사용하는 경우
  public InterenalServerException(AccountErrorCode code) {
  ...
  public InterenalServerException(AccountErrorCode code, String detailMessage) {
